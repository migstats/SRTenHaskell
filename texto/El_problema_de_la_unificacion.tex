...
\texttt{REGLA} (si durante la reescritura no se puede aplicar ninguna
regla más).
\begin{codigo}
...
\index{\texttt{(unificacion t1 t2)}} \texttt{(unificacion t1 t2)} es
\begin{itemize}
...
Por ejemplo,
\begin{sesion}
ghci> unificacion (T "f" [V ("x",0), T "g" [V ("z",0)]])
                  (T "f" [T "g" [V ("y",0)], V ("x",0)])
Right [(("z",0),V ("y",0)),(("x",0),T "g" [V ("y",0)])]
ghci> unificacion (T "f" [V ("x",0),T "b" []])
                  (T "f" [T "a" [],V ("y",0)])
Right [(("y",0),T "b" []),(("x",0),T "a" [])]
ghci> unificacion (T "f" [V ("x",0),V ("x",0)])
                  (T "f" [T "a" [],T "b" []])
Left UNIFICACION
ghci> unificacion (T "f" [V ("x",0),T "g" [V ("y",0)]])
                  (T "f" [V ("y",0),V ("x",0)])
Left UNIFICACION
\end{sesion}
...
\index{\texttt{(unificacionS es s)}} \texttt{(unificacionS es s)} es
\begin{itemize}
...
Por ejemplo,
\begin{sesion}
ghci> unificacionS [(T "f" [V ("x",0), T "g" [V ("z",0)]],
                   T "f" [T "g" [V ("y",0)], V ("x",0)])]
                   []
Right [(("z",0),V ("y",0)),(("x",0),T "g" [V ("y",0)])]
ghci> unificacionS [(T "f" [V ("x",0),T "b" []],
                   T "f" [T "a" [],V ("y",0)])]
                   []
Right [(("y",0),T "b" []),(("x",0),T "a" [])]
ghci> unificacionS [(T "f" [V ("x",0),V ("x",0)],
                   T "f" [T "a" [],T "b" []])]
                   []
Left UNIFICACION
ghci> unificacionS [(T "f" [V ("x",0),T "g" [V ("y",0)]],
                   T "f" [V ("y",0),V ("x",0)])]
                   []
Left UNIFICACION
\end{sesion}
...
\index{\texttt{(reglaElimina x t es s)}} \texttt{(reglaElimina x t es s)} es
\begin{itemize}
...
\index{\texttt{(equiparacion t1 t2)}} \texttt{(equiparacion t1 t2)} es
\begin{itemize}
...
Por ejemplo,
\begin{sesion}
ghci> let t1 = T "f" [V ("x",0), T "a" []]
ghci> let t2 = T "f" [T "b" [],  T "a" []]
ghci> equiparacion t1 t2
Right [(("x",0),T "b" [])]
ghci> equiparacion t2 t1
Left UNIFICACION
ghci> let t3 = T "f" [V ("x",0), V ("y",0)]
ghci> equiparacion t1 t3
Left UNIFICACION
\end{sesion}
...
\index{\texttt{(equiparacionS es s)}} \texttt{(equiparacionS es s)} es
\begin{itemize}
...
ghci> let t1 = T "f" [V ("x",0), T "a" []]
ghci> let t2 = T "f" [T "b" [],  T "a" []]
ghci> equiparacionS [(t1,t2)] []
Right [(("x",0),T "b" [])]
ghci> equiparacionS [(t2,t1)] []
Left UNIFICACION
ghci> let t3 = T "f" [V ("x",0), V ("y",0)]
ghci> equiparacionS [(t1,t3)] []
Left UNIFICACION
\end{sesion}
...
\index{\texttt{(reescribe es t)}} \texttt{(reescribe es t)} es
\begin{itemize}
...
\index{\texttt{(formaNormal es t)}} \texttt{(formaNormal es t)} es la forma normal de \texttt{t} respecto
