...
es terminador, es indecidible. Aunque en casos mas restringidos si
...
las reducciones son terminadoras empezando por $t$ es indecidible.
...
reducciones desde todos los posibles términos sean terminadores. Puede
darse el caso que tengamos una configuración de términos que termine,
pero una reducción no terminadora que empiece por un término que no
...
llamaremos básicos hacia la derecha, y probaremos que son terminadores.
...
los sistemas de reescritura con los órdenes, si $R$ es terminadora,
